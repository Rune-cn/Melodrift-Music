...
private val MelodriftLight = lightColorScheme(
    ...
    // 中性容器色阶：原来自动落到 M3 默认（浅色 surfaceContainerHighest≈#E6E0E9 发紫），
    // 显式定义成与 #F0F1F3 同族的中性灰；设置卡片用 surfaceContainerHighest。
    surfaceContainerLowest = Color(0xFFFAFAFB),
...
private val MelodriftDark = darkColorScheme(
    ...
    surfaceContainerHighest = Color(0xFF27282B),
